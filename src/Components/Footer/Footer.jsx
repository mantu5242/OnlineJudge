        ...
        <div className='footer-wrapper'>
            <div class="full">
                ...
                <div class="secondContainer">
                    <div class="location">
                        <h3>CODERS OF NIT JAMSHEDPUR</h3>
                        <p>
                    ...
                    <div class="social">
                        ...
                        <div class="imgContainer">
                            <a href="https://instagram.com/pconjsr?igshid=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer">
                                <img src={instagram} alt="" />
                            </a>
                            <a href="https://twitter.com/dccnita" target="_blank" rel="noopener noreferrer">
                                <img src={twitter} alt="" />
                            </a>
                            <a href="https://www.linkedin.com/company/pconjsr" target="_blank" rel="noopener noreferrer" >
